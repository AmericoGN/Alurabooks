<h1 align="center">Projeto completo HTML e CSS: responsividade com mobile-first<h1>
...
<h2>Tecnologias</h2>
    ...
    As aulas ofertaram técnicas de HTML 5.0, CSS 3.0 e SwiperJS 8.0.
    A implementação foi mediana, sem explorar classes avançadas ou implementações complexas de Java.
    O uso de Media Query foi vital para resoluções maiores (1024px e 1728px), que permitiram mudanças significativas de design.
    O principal é que mesmo com o caos no código, ele funciona de uma forma satisfatoria e funcional!
